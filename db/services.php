...
$functions = call_user_func(function(){
	$definitions = [
		...
		[ 'block_exacomp_get_topics', 'read', 'Get topics for a given subject.' ],
		[ 'block_exacomp_get_subtopics', 'read', 'Get subtopics for a given topic.' ],
		[ 'block_exacomp_set_subtopic', 'write', 'Set a users subtopic evaluation.' ],
		[ 'block_exacomp_get_competencies', 'read', 'Get subtopic competencies and teacher/student evaluation.' ],
		[ 'block_exacomp_set_competence', 'write', 'Set a student evaluation for a particular competence' ],
		[ 'block_exacomp_get_associated_content', 'read', 'Get contents for a competence (exaport,example,assign)' ],
		[ 'block_exacomp_get_assign_information', 'read', 'Get information about a particular assign' ],
		[ 'block_exacomp_update_assign_submission', 'write', 'Updates info for particular assign' ],
		[ 'block_exacomp_get_competence_by_id', 'read', 'Get competence title' ],
		[ 'block_exacomp_get_topic_by_id', 'read', 'Get topic title' ],
		[ 'block_exacomp_get_subtopics_by_topic', 'read', 'Get subtopics by topic id' ],
		...
		[ 'block_exacomp_get_item_example_status', 'read', 'Get Example Status' ],
		...
		[ 'block_exacomp_get_item_grading', 'read', 'get grading of an item' ],
		...
		[ 'dakora_get_user_fullname', 'read', 'get fullname of the current user' ],
		[ 'dakora_set_competence', 'write', 'set a user competence' ],
		...
		[ 'dakora_get_comp_grid_for_example', 'read', 'get competence grid for a specific example' ],
		...
		[ 'dakora_send_message_to_course', 'write', 'sends a message to all course students' ],
