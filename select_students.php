...
if ($crosssubjid > 0 && (!$crosssubject = $DB->get_record(DB_CROSSSUBJECTS, array('id' => $crosssubjid))))
{
...
$assigned_students = $DB->get_records_menu(DB_CROSSSTUD,array('crosssubjid'=>$crosssubjid),'','studentid,crosssubjid');
