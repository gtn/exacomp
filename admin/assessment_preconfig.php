...
$integerfields = array(
    ...
    'assessment_example_diffLevel',
    'assessment_example_SelfEval',
    'assessment_childcomp_scheme',
    'assessment_childcomp_diffLevel',
    'assessment_childcomp_SelfEval',
    'assessment_comp_scheme',
    'assessment_comp_diffLevel',
    'assessment_comp_SelfEval',
    'assessment_topic_scheme',
    'assessment_topic_diffLevel',
    'assessment_topic_SelfEval',
    'assessment_subject_scheme',
    'assessment_subject_diffLevel',
    'assessment_subject_SelfEval',
    'assessment_theme_scheme',
    'assessment_theme_diffLevel',
    'assessment_theme_SelfEval',
