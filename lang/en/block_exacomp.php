...
$string['subject_headline'] = 'Subject settings';
$string['topic_headline'] = 'Topic settings';
$string['topic_description'] = 'Create your first topic:';
$string['niveau_headline'] = 'Niveau settings';
$string['niveau_description'] = 'Create your first Niveau:';
$string['descriptor_name'] = 'Descriptor name';
