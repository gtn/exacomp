...
$string['tab_skillsmanagement'] = 'Manage competencies';
...
$string['settings_skillsmanagement'] = 'Use skills-management';
$string['settings_skillsmanagement_description'] = 'Check to use skills-management-tool instead of import';
