...
return [
	...
	'settings_admin_scheme' => [
		'Globales Bewertungsschema',
		'Global grading scheme',
	],
	'settings_admin_scheme_description' => [
		'Wählen Sie ein kursübergreifendes Bewertungsschema, andernfalls kann der/die LehrerIn pro Kurs ein zahlen basiertes Bewertungsschema festlegen.',
		'Choose a grading scheme for all courses, if not every teacher can select an own grading scheme for every course based on numbers.',
	],
	'settings_admin_scheme_none' => [
		'keine globale Bewertung',
		'no global grading',
	],
...
',
	...
	'usetopicgrading' => [
		'Beurteilung von Teilbereichen ermöglichen',
		'Allow to grade topics',
	],
	'usenumbering' => [
	...
	'lisfilename' => [
		'Dateiname nach LS Vorgabe generieren',
		'Use LIS filename template',
	],
	'solution' => [
		'Musterlösung',
		'Solution',
