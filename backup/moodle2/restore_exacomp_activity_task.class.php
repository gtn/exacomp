...
require_once($CFG->dirroot . '/blocks/exacomp/backup/moodle2/restore_exacomp_activity_stepslib.php'); // We have structure steps

class restore_exacomp_activity_task extends restore_activity_task {
