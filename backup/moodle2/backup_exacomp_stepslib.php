...
class backup_exacomp_block_structure_step extends backup_block_structure_step {
	...
	protected function define_structure() {
		...
		$settings = new backup_nested_element('settings', array(), array('courseid','grading','tstamp','uses_activities','show_all_descriptors','profoundness','show_all_examples','nostudents'
