...
echo $OUTPUT->box(block_exacomp_get_string('weekly_schedule_link_to_grid','block_exacomp'));

if($studentid == 0) {
	echo html_writer::div(block_exacomp_get_string('add_example_for_all_students_to_schedule','block_exacomp') .
				html_writer::tag("input", "", array("id"=>"add-examples-to-schedule-for-all", "name" => "add-examples-to-schedule-for-all", "type" => "submit", "value" => block_exacomp_get_string("save_selection", "block_exacomp")))
			,"alert alert-warning");
}
