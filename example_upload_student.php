...
$item = $DB->get_record('block_exacompitem_mm', array("exampleid"=>$exampleid),'*',IGNORE_MULTIPLE);
if($exampleid && $item) {
...
if($formdata = $form->get_data()) {
   ...
   //store item in the right portfolio category
	...
	$DB->insert_record('block_exacompitem_mm',array('exampleid'=>$newExample->id,'itemid'=>$itemid,'timecreated'=>time(),'status'=>0));
