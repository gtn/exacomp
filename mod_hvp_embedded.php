<?php
// This should all not be needed, since this extension comes with an embed feature.
...
//
///**
// * Prints an instance of mod_hvp.
// * But without footer and header
// * Based on mod/hvp/view.php
// */
//
//require_once("../../config.php");
//require_once("../../mod/hvp/locallib.php");
//
...
//$PAGE->set_url(new \moodle_url('/blocks/exacomp/mod_hvp_embedded.php', array('id' => $id)));
